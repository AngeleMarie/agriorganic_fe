        ...
        <div className="flex flex-col md:flex-row bg-white rounded-lg shadow-xl">
          ...
          <img src="banju.svg" alt="banju" className="absolute top-0 left-0 opacity-10 " />
            ...
            <div className="flex space-x-4 mt-12 absolute bottom-12">
              <div className="bg-[#266937] rounded-full p-2 shadow-md hover:bg-white hover:text-[#266937]">
          ...
          <form onSubmit={handleSubmit} className="p-8 md:w-2/3 relative">
            <div className="md:grid-cols-2 mb-6 p-8">
              <div className="flex">
                <div className="w-full pr-4">
                  <label
                    htmlFor="firstName"
                    className="text-main-green block  focus:font-semibold"
                  >
                    First Name
                  </label>
                  <input
            ...
            <div className="mb-6">
              <label className="text-other-green block font-semibold px-8">
                Select Subject?
              </label>
