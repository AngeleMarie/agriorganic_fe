      ...
      <div className="container mx-auto text-center">
        ...
        <form className="max-w-3xl mx-auto">
          <div className="flex w-full">
            <input type="text" placeholder="Name" className="flex-grow mr-2  bg-main-green border-2 h-12 w-1/3 rounded-md outline-none  px-2 text-white border-white " />
            <input type="email" placeholder="Email address" className="flex-grow mr-2 bg-main-green border-2 h-12 w-96 rounded-md outline-none  px-2 text-white border-white" />
