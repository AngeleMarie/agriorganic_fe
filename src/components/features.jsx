  ...
  return (
    <div className="bg-main-green py-16">
      <div className="container mx-auto px-4">
        <p className="text-4xl font-bold text-center mb-6 text-some-blue">Why Agriorganic ?</p>
            ...
            {leftFeatures.map((feature, index) => (
              <div key={index} className="flex items-start mb-4 mx-12">
                <div className="flex-shrink-0 mr-4">
                  <div className="w-12 h-12 rounded-full bg-some-blue flex items-center justify-center">
                    <feature.icon className="w-6 h-6 text-white" />
                  </div>
                </div>
                <div>
                  <h3 className="text-lg font-semibold mb-2 text-some-blue">{feature.title}</h3>
